-- Add basic equipment seed data for inventory management
...
('RJ45 Connectors', 'Connector', 'Panduit', 'MP588', 'Available', 0.45, ''),
...
('Cable Tester', 'Tool', 'Fluke', 'DTX-1800', 'Available', 8500.00, '7.20'),
('Crimping Tool', 'Tool', 'Klein', 'VDV226-011', 'Available', 45.00, ''),
('Cable Stripper', 'Tool', 'Klein', 'VDV100-061', 'Available', 25.00, ''),
('Wall Plates Single', 'Accessory', 'Leviton', '41080-1WP', 'Available', 3.50, ''),
('Wall Plates Dual', 'Accessory', 'Leviton', '41080-2WP', 'Available', 4.25, ''),
('Keystone Jacks Cat6', 'Connector', 'Panduit', 'CJ688TGBU', 'Available', 8.75, ''),
